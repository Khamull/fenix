...
sql = "SELECT * from tb_cargo ORDER BY carDescr ASC" 
if (keyword = "") then
else
sql = "SELECT * from tb_cargo WHERE carDescr LIKE '%"&keyword&"%' ORDER BY carDescr ASC" 
end if
%>
...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
	    ...
	    <li><a href="pg_insert_cargo.asp">Novo Cargo</a></li>          
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">CARGOS</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      ...
      <tr class="textoBranco">
        ...
        <td colspan="3" align="left" bgcolor="#9E231B">Cargo</td>
      ...
      <tr>
        <td align="left"><%=(rs01.Fields.Item("carID").Value)%></td>
        <td colspan="3" align="left"><%=(rs01.Fields.Item("carDescr").Value)%></td>
        <td><a href="pg_update_cargo.asp?carID=<%=(rs01.Fields.Item("carID").Value)%>"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td><img src="ico/ico_<%=(rs01.Fields.Item("carAtivo").Value)%>.gif" width="15" height="15" border="0"/></td>
