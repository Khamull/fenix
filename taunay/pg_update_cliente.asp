...
'------------ VERIFICA SE JÁ TEM O TELEFONE CADASTRADO ---------------------------
	...
	set rs00x = server.CreateObject("adodb.recordset")
		...
		sql00x = "SELECT * FROM tb_cliente WHERE cliTelefone = '"&cliTelefone&"' AND cliID <> '"&cliID&"' OR cliTelefone2 = '"&cliTelefone&"' AND cliID <> '"&cliID&"' OR cliTelefone3 = '"&cliTelefone&"' AND cliID <> '"&cliID&"' OR cliTelefone4 = '"&cliTelefone&"' AND cliID <> '"&cliID&"' OR cliTelefone5 = '"&cliTelefone&"' AND cliID <> '"&cliID&"'"
	...
	set rs001 = server.CreateObject("adodb.recordset")
		...
		sql001 = "SELECT * FROM tb_cliente WHERE cliTelefone = '"&cliTelefone2&"' AND cliID <> '"&cliID&"' OR cliTelefone2 = '"&cliTelefone2&"' AND cliID <> '"&cliID&"' OR cliTelefone3 = '"&cliTelefone2&"' AND cliID <> '"&cliID&"' OR cliTelefone4 = '"&cliTelefone2&"' AND cliID <> '"&cliID&"' OR cliTelefone5 = '"&cliTelefone2&"' AND cliID <> '"&cliID&"'"
	...
	set rs002 = server.CreateObject("adodb.recordset")
		...
		sql002 = "SELECT * FROM tb_cliente WHERE cliTelefone = '"&cliTelefone3&"' AND cliID <> '"&cliID&"' OR cliTelefone2 = '"&cliTelefone3&"' AND cliID <> '"&cliID&"' OR cliTelefone3 = '"&cliTelefone3&"' AND cliID <> '"&cliID&"' OR cliTelefone4 = '"&cliTelefone3&"' AND cliID <> '"&cliID&"' OR cliTelefone5 = '"&cliTelefone3&"' AND cliID <> '"&cliID&"'"
	...
	set rs003 = server.CreateObject("adodb.recordset")
		...
		sql003 = "SELECT * FROM tb_cliente WHERE cliTelefone = '"&cliTelefone4&"' AND cliID <> '"&cliID&"' OR cliTelefone2 = '"&cliTelefone4&"' AND cliID <> '"&cliID&"' OR cliTelefone3 = '"&cliTelefone4&"' AND cliID <> '"&cliID&"' OR cliTelefone4 = '"&cliTelefone4&"' AND cliID <> '"&cliID&"' OR cliTelefone5 = '"&cliTelefone4&"' AND cliID <> '"&cliID&"'"
	...
	set rs004 = server.CreateObject("adodb.recordset")
		...
		sql004 = "SELECT * FROM tb_cliente WHERE cliTelefone = '"&cliTelefone5&"' AND cliID <> '"&cliID&"' OR cliTelefone2 = '"&cliTelefone5&"' AND cliID <> '"&cliID&"' OR cliTelefone3 = '"&cliTelefone5&"' AND cliID <> '"&cliID&"' OR cliTelefone4 = '"&cliTelefone5&"' AND cliID <> '"&cliID&"' OR cliTelefone5 = '"&cliTelefone5&"' AND cliID <> '"&cliID&"'"
...
sql022   = "SELECT * FROM tb_cliente INNER JOIN tb_bairro ON tb_cliente.baiID = tb_bairro.baiID WHERE tb_cliente.cliID = '"&cliID&"'"
set rs22 = conn.execute(sql022)
...
conteudo =  "Pizzaria Ponto de Encontro" & vbcrlf

conteudo =  conteudo & "contato@pizzariapontodeencontro.com.br" & vbcrlf

conteudo =  conteudo & "  " & vbcrlf

conteudo =  conteudo & "Caro cliente "& cliNome &"!"& vbcrlf

conteudo =  conteudo & "Aqui estao seus dados cadastrais mais Login e Senha de acesso:" & vbcrlf

conteudo =  conteudo & "  " & vbcrlf

conteudo =  conteudo & "E-mail: "& cliEmail & vbcrlf

conteudo =  conteudo & "Senha :"& cliSenha & vbcrlf

conteudo =  conteudo & "  " & vbcrlf

conteudo =  conteudo & "Nome: "& cliNome & vbcrlf

conteudo =  conteudo & "Endereco: "& cliEndereco & vbcrlf

'conteudo =  conteudo & "Numero: "& numero & vbcrlf

conteudo =  conteudo & "Bairro: "& rs22.Fields.Item("baiNome").Value & vbcrlf

'conteudo =  conteudo & "Cep: "& cep & vbcrlf

'conteudo =  conteudo & "UF: "& uf & vbcrlf

'conteudo =  conteudo & "Aniversario: "& aniversario & vbcrlf

conteudo =  conteudo & "Tel: "& cliTelefone & vbcrlf

conteudo = conteudo & "Preferencias: " & cliPreferencias & vbcrlf

'conteudo =  conteudo & "Email: "& email & vbcrlf


set mail = server.createobject("cdonts.newmail")

mail.from = "contato@pizzariapontodeencontro.com.br" 'Este email deve ser válido e existir como conta de email para o domínio

mail.to   = cliEmail

mail.subject = "Dados Cadastrais Pizzaria Ponto de Encontro"
...
mail.send
    ...
    Set mail = nothing
		...
		set rs01 = nothing
			...
			response.redirect("pg_select_cliente.asp")
	end if
end if
%>
...
set rs03 = server.CreateObject("adodb.recordset")
	sql03 = "SELECT * FROM tb_bairro where baiAtivo = 'S' ORDER BY baiNome"
...
window.location.href="pg_update_cliente.asp?cliID=25&cidID=3"
...
*</td>
        ...
        <tr>
          ...
          <td height="25" align="left"><input name="cliTelefone" type="text" id="cliTelefone" value="<%=rs00.fields.item("cliTelefone").value%>" size="9" maxlength="9" />
*</td>
          <td height="25" align="right">Telefone 2:</td>
          <td height="25" align="left"><input name="cliTelefone2" type="text" id="cliTelefone2" value="<%=rs00.fields.item("cliTelefone2").value%>" size="9" maxlength="9" /></td>
        </tr>
        <tr>
          <td height="25" align="right">Telefone 3:</td>
          <td height="25" align="left"><input name="cliTelefone3" type="text" id="cliTelefone3" value="<%=rs00.fields.item("cliTelefone3").value%>" size="9" maxlength="9" /></td>
          <td height="25" align="right">Telefone 4:</td>
          <td height="25" align="left"><input name="cliTelefone4" type="text" id="cliTelefone4" value="<%=rs00.fields.item("cliTelefone4").value%>" size="9" maxlength="9" /></td>
        </tr>
        <tr>
          <td height="25" align="right">Telefone 5:</td>
          <td height="25" align="left"><input name="cliTelefone5" type="text" id="cliTelefone5" value="<%=rs00.fields.item("cliTelefone5").value%>" size="9" maxlength="9" /></td>
          <td height="25" align="right">&nbsp;</td>
          <td height="25" align="left">&nbsp;</td>
        </tr>
        <tr>
