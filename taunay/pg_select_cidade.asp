...
sql = "SELECT * from tb_cidade ORDER BY cidNome ASC" 
if (keyword = "") then
else
sql = "SELECT * from tb_cidade WHERE cidNome LIKE '%"&keyword&"%' ORDER BY cidNome ASC" 
end if
%>
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">CIDADES</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      ...
      <tr class="textoBranco">
        ...
        <td colspan="3" align="left" bgcolor="#9E231B">Cidade</td>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("cidID").Value)%></td>
        <td colspan="3" align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("cidNome").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_cidade.asp?cidID=<%=(rs01.Fields.Item("cidID").Value)%>"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("cidAtiva").Value)%>.gif" width="15" height="15" border="0"/></td>
