...
sql = "SELECT * from tb_fornecedor WHERE forID <> '300' ORDER BY forNome ASC" 
if (keyword = "") then
else
sql = "SELECT * from tb_fornecedor WHERE forNome LIKE '%"&keyword&"%' AND forID <> '300' ORDER BY forNome ASC" 
end if
%>
...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
	    ...
	    <li><a href="pg_insert_fornecedor.asp">Nova fornecedor</a></li>          
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">FORNECEDORES</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      <tr class="textoBranco">
        ...
        <td width="344" align="left" bgcolor="#FFFFFF">
        ...
        <td width="100" align="left" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr class="textoBranco">
        ...
        <td align="left" bgcolor="#9E231B">Fornecedor</td>
        <td align="left" bgcolor="#9E231B">Telefone</td>
        <td width="120" align="left" bgcolor="#9E231B">Cnpj/CPF</td>
        <td width="120" align="left" bgcolor="#9E231B">IE/RG</td>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("forID").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("forNome").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("forTelefone").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("forCnpj").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("forIE").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_fornecedor.asp?forID=<%=(rs01.Fields.Item("forID").Value)%>"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("forAtivo").Value)%>.gif" width="15" height="15" border="0"/></td>
