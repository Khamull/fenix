...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
	...
	DIm MM_recordId
	    ...
	    empresaTitulo = Replace(Trim(Request.QueryString("empresaTitulo")),"'","")
	    empresaTexto  = Replace(Trim(Request.QueryString("empresaTexto")),"'","")
		MM_recordId   = Request.QueryString("MM_recordId")
   ...
   ' MM_editCmd.Execute
    ...
    MM_editRedirectUrl = "sis_update_empresa.asp?cadastrado=OK"
...
Dim empresaID
    ...
    empresaID = Request.QueryString("empresaID")
if(acao = "1") then 

set rs1 = Server.CreateObject("ADODB.Recordset")
sql01   = "DELETE FROM tb_empresa WHERE empresaID = '"&empresaID&"'"
set rs1 = conn.execute(sql01)
response.Redirect("sis_update_empresa.asp")

elseif(acao = "2") Then

set rs02 = Server.CreateObject("ADODB.Recordset")
sql02   = "INSERT INTO tb_empresa (empresaTitulo, empresaTexto) VALUES ('TITULO','TEXTO')"
...
<div id="areaConteudo">
    ...
    <div><!--<a href="javascript: inserir()"><input type="button" value="+ Novo T&oacute;pico" class="botao" border="0"/></a>--><a href="sis_update_imagem_empresa.asp"><input type="button" value="+ Editar Imagens" class="botao" border="0"/></a><!--<a href="sis_slides.asp"><input type="button" value="+ Editar Banners" class="botao" border="0"/></a>--></div>
        ...
        <form  name="form1" id="form1" action="sis_update_empresa.asp" method="get">
        ...
        <tr valign="baseline">
          ...
          <td align="left"><input type="hidden" name="empresaTitulo" value="titulo" size="52"/></td>
          <td valign="top"></td>
        </tr>
        <tr valign="baseline">
          <td align="left" valign="top" nowrap="nowrap"><strong>Texto:</strong></td>
          <td align="left">
          <textarea name="empresaTexto" cols="120" rows="15" id="area1"><%=(Recordset2.Fields.Item("empresaTexto").Value)%></textarea></td>
          <td valign="top">&nbsp;
