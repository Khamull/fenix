...
if (not isEmpty(Request.Form("lancar"))) then
	...
	Response.redirect("pg_insert_itemVendaBalcao1.asp?venID="&Request.QueryString("venID"))
...
response.redirect("pg_select_pedidos_balcao.asp")
...
window.location.href = "pg_insert_itemVendaBalcao1.asp?venID="+venID+"&itePreco="+itePreco+"&iteQtde="+iteQtde+"&tipDescr="+tipDescr+"&tipID="+tipID+"&cliID="+cliID;
...
window.location.href = "pg_insert_itemVendaBalcao1.asp?venID="+venID+"&itePreco="+itePreco+"&iteQtde="+iteQtde+"&tipDescr="+tipDescr+"&tipID="+tipID+"&cliID="+cliID+"&proDescricao="+proDescricao+"&proID="+proID;
...
function excluirPedido(staID)
{
	...
	{
		if(staID != "10"){
			window.location.href = "pg_insert_itemVendaBalcao1.asp?acao=excluirPedido&venID=<%=Request.QueryString("venID")%>";
		}else{
		window.open("pg_excluir_pedidos.asp?venID=<%=Request.QueryString("venID")%>&tipo=balcao", "Excluir", "width=300px, height=260px");
		}
	}
}	
</script>
...
<div id="areaConteudo">
  ...
  <tr>
    <td width="50" align="center"><a href="pg_insert_compra.asp"><img src="ico/ico_cesta.gif" alt="" width="60" height="60" border="0" class="icone" /></a></td>
...
%>
 <tr class="textoComum">
   ...
   <td align="left" valign="middle" bgcolor="#FFFFFF"><a href="pg_insert_itemVendaBalcao1.asp?venID=<%=request.querystring("venID")%>&acao=excluirItem&idItem=<%=rs07.fields.item("iteID").value%>"><img src="ico/ico_excluir.gif" width="15" height="15" border="0"/></a></td>
 </tr>
 <%
 rs07.moveNext
 loop
