...
sql = "SELECT *, tb_tipo.tipDescr from tb_produto INNER JOIN tb_tipo ON tb_tipo.tipID = tb_produto.tipID ORDER BY proDescricao ASC" 
if (keyword = "") then
else
sql = "SELECT *, tb_tipo.tipDescr from tb_produto INNER JOIN tb_tipo ON tb_tipo.tipID = tb_produto.tipID WHERE tb_produto.proDescricao LIKE '%"&keyword&"%' ORDER BY proDescricao ASC" 
end if
%>
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">PRODUTO</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      <tr class="textoBranco">
        ...
        <td width="308" align="left" bgcolor="#FFFFFF">
        ...
        <td width="140" align="left" bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF">&nbsp;</td>
      </tr>
      <tr class="textoBranco">
        <td width="29" align="left" bgcolor="#9E231B">ID</td>
        <td align="left" bgcolor="#9E231B">produto</td>
        <td width="70" align="left" bgcolor="#9E231B">Cód do Pro.</td>
        <td width="81" align="left" bgcolor="#9E231B">Preço Custo</td>
        <td width="80" align="left" bgcolor="#9E231B">Preço Venda</td>
        <td align="left" bgcolor="#9E231B">Tipo</td>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("proID").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("proDescricao").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("proCodEmpresa").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=Replace(FormatNumber(rs01.Fields.Item("proPrecoCusto").Value),",",".")%></td>
        <td align="left" bgcolor="<%=cor%>"><%=Replace(FormatNumber(rs01.Fields.Item("proPrecoVenda").Value),",",".")%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("tipDescr").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_produto.asp?proID=<%=(rs01.Fields.Item("proID").Value)%>"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("proAtivo").Value)%>.gif" width="15" height="15" border="0"/></td>
...
%>
      <tr>
        <td colspan="8" align="left"><table border="0" align="center">
            <tr>
