...
sql = "SELECT tb_bairro.baiID, tb_bairro.baiNome, tb_bairro.baiFrete, tb_bairro.baiAtivo, tb_bairro.cidID, tb_cidade.cidNome FROM tb_bairro INNER JOIN tb_cidade ON tb_cidade.cidID = tb_bairro.cidID GROUP BY tb_bairro.baiID ORDER BY tb_cidade.cidID, tb_bairro.baiID ASC" 
if (keyword = "") then
else
sql = "SELECT tb_bairro.baiID, tb_bairro.baiNome, tb_bairro.baiFrete, tb_bairro.baiAtivo, tb_bairro.cidID, tb_cidade.cidNome FROM tb_bairro INNER JOIN tb_cidade ON tb_cidade.cidID = tb_bairro.cidID WHERE tb_bairro.baiNome LIKE '%"&keyword&"%' GROUP BY tb_bairro.baiID ORDER BY tb_cidade.cidID, tb_bairro.baiID ASC" 
end if
%>
...
rs01_cmd.CommandText = sql '"SELECT tb_bairro.baiID, tb_bairro.baiNome, tb_bairro.baiFrete, tb_bairro.baiAtivo, tb_bairro.cidID, tb_cidade.cidNome FROM tb_bairro INNER JOIN tb_cidade ON tb_cidade.cidID = tb_bairro.cidID GROUP BY tb_bairro.baiID ORDER BY tb_cidade.cidID, tb_bairro.baiID ASC" 
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">BAIRROS</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      ...
      <tr class="textoBranco">
        <td width="40" align="left" bgcolor="#9E231B">ID</td>
        <td width="340" align="left" bgcolor="#9E231B">Bairro</td>
        <td width="100" align="left" bgcolor="#9E231B">Valor do Frete</td>
        <td width="240" align="left" bgcolor="#9E231B">Cidade</td>
        <td width="15" bgcolor="#9E231B">Ed</td>
        <td width="18" bgcolor="#9E231B">St</td>
      </tr>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("baiID").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("baiNome").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=Replace(FormatNumber(rs01.Fields.Item("baiFrete").Value),",",".")%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("cidNome").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_bairro.asp?baiID=<%=(rs01.Fields.Item("baiID").Value)%>" target="_top"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("baiAtivo").Value)%>.gif" width="15" height="15" border="0"/></td>
...
%>
      <tr>
        <td colspan="6" align="left"><table border="0" align="center">
            <tr>
