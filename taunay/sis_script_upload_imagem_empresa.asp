...
sql06 = "SELECT COUNT(*) AS Y FROM tb_imagemempresa WHERE imagemID = '"&imagemID&"'"
...
sql05 = "SELECT * FROM tb_imagemempresa WHERE imagemID = "&imagemID 
...
imagem = imagemID & ".jpg"   
objUpload.Files("imagem").SaveAs("upload_empresa/" & imagemID & ".jpg")   
...
sql01 = "UPDATE tb_imagemempresa SET imagemCaminho = '"&imagemID&"' WHERE imagemID = "&Request.QueryString("imagemID")
