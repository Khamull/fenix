...
sql01 = "SELECT * FROM tb_imagemempresa WHERE imagemID = '"&imagemID&"'"
...
<body>
<form action="sis_script_upload_imagem_empresa.asp?imagemID=<%=Request.Querystring("imagemID")%>" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return verForm(this)">
