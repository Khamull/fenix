...
sql = "SELECT *, tb_cargo.carDescr FROM tb_funcionario INNER JOIN tb_cargo ON tb_cargo.carID = tb_funcionario.carID ORDER BY funNome ASC" 
if (keyword = "") then
else
sql = "SELECT *, tb_cargo.carDescr FROM tb_funcionario INNER JOIN tb_cargo ON tb_cargo.carID = tb_funcionario.carID WHERE tb_funcionario.funNome LIKE '%"&keyword&"%' ORDER BY funNome ASC" 
end if
%>
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">FUNCIONARIOS</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      ...
      <tr class="textoBranco">
        ...
        <td width="328" align="left" bgcolor="#9E231B">Funcionário</td>
        <td width="130" align="left" bgcolor="#9E231B">CPF</td>
        <td width="70" align="left" bgcolor="#9E231B">Telefone</td>
        <td width="160" align="left" bgcolor="#9E231B">Cargo</td>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("funID").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("funNome").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("funCpf").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("funTelefone").Value)%></td>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("carDescr").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_funcionario.asp?funID=<%=(rs01.Fields.Item("funID").Value)%>" target="_top"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("funAtivo").Value)%>.gif" width="15" height="15" border="0"/></td>
