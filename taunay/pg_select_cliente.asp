...
sql = "SELECT *, tb_bairro.baiNome from tb_cliente INNER JOIN tb_bairro ON tb_bairro.baiID = tb_cliente.baiID WHERE tb_cliente.cliAtivo = 'S' ORDER BY tb_cliente.cliNome, tb_cliente.baiID ASC" 
if (keyword = "") then
else
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">CLIENTES</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      <tr class="textoBranco">
        ...
        <td colspan="3" align="right"><input type="button" class="botao" value="Clientes Novos (Site) &rarr;" onClick="javascript: window.location.href='pg_select_new_cliente.asp';" /></td>
        </tr>
      <tr class="textoBranco">
