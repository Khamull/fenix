...
sql = "SELECT * from tb_tipo ORDER BY tipDescr ASC" 
if (keyword = "") then
else
sql = "SELECT * from tb_tipo WHERE tipDescr LIKE '%"&keyword&"%' ORDER BY tipDescr ASC" 
end if
%>
...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
	    ...
	    <li><a href="pg_insert_tipoProduto.asp">Nova Tipo de Produto</a></li>          
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">TIPO DE PRODUTO</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      <tr class="textoBranco">
        ...
        <td width="240" align="left" bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF">&nbsp;</td>
      </tr>
      <tr class="textoBranco">
        <td width="30" align="left" bgcolor="#9E231B">ID</td>
        <td colspan="3" align="left" bgcolor="#9E231B">Tipo</td>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("tipID").Value)%></td>
        <td colspan="3" align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("tipDescr").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_tipoProduto.asp?tipID=<%=(rs01.Fields.Item("tipID").Value)%>"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("tipAtivo").Value)%>.gif" width="15" height="15" border="0"/></td>
