...
if (not isEmpty(Request.Form("cadastrar"))) then
	...
	set rs00 = server.CreateObject("adodb.recordset")
		sql00 = "SELECT * FROM tb_cidade WHERE cidNome = '"&cidNome&"'"
	...
	'Grava
		...
		set rs01 = server.CreateObject("adodb.recordset")
			sql01 = "INSERT INTO tb_cidade (usuLogin, cidNome) VALUES ('"&usuLogin&"','"&cidNome&"')"
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">CADASTRO DE CIDADE</td>
    </tr>
  <tr>
      ...
      <table width="777" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
          ...
          <td width="267" height="25" align="left"><label>
            <input name="cidNome" type="text" id="cidNome" size="40" maxlength="30" />
          *</label></td>
