...
if (not isEmpty(Request.Form("cadastrar"))) then
	...
	set rs00 = server.CreateObject("adodb.recordset")
		sql00 = "SELECT * FROM tb_cargo WHERE carDescr = '"&carDescr&"'"
	...
	'Grava
		...
		set rs01 = server.CreateObject("adodb.recordset")
			sql01 = "INSERT INTO tb_cargo (usuLogin, carDescr) VALUES ('"&usuLogin&"','"&carDescr&"')"
...
if (carDescr.length < 3) {
	alert("Favor informar o cargo corretamente!");
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">CADASTRO DE CARGO</td>
    </tr>
  <tr>
      ...
      <table width="777" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
          ...
          <td width="267" height="25" align="left"><label>
            <input name="carDescr" type="text" id="carDescr" size="40" maxlength="30" />
          *</label></td>
