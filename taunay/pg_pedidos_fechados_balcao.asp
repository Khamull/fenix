...
sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 10 AND tb_venda.tipVendaID = 3 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
else 

	select case filtro
	
	case 3
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 10 AND tb_venda.venID '"&keyword&"' AND tb_venda.tipVendaID = 3 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 4
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 10 AND tb_venda.usuLogin LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 3 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	end select 
...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
        ...
        <li><a href="pg_select_pedidos_balcao.asp">Pedidos Abertos</a></li>
	  </ul>
	</div>
    ...
    <table width="96%" border="0" align="left" cellpadding="3" cellspacing="3">
      <tr>
        ...
        <td width="751" align="center" class="titulo">PEDIDOS FECHADOS - BALCÃO</td>
      </tr>
      <tr>
...
<option selected="selected"> </option>
            ...
            <tr class="textoBranco">
              <td width="56" align="left" bgcolor="#9E231B">&nbsp;Codigo</td>
              <td width="74" align="left" bgcolor="#9E231B">Data</td>
              <td width="74" align="left" bgcolor="#9E231B">Hora</td>
              <td width="517" align="left" bgcolor="#9E231B">Atendente&nbsp;</td>
...
%>
			...
			<%if (rs01.Fields.Item("staID").Value = "10") Then%>
              ...
              <tr>
                ...
                <td><a href="sis_devolve_balcao.asp?venID=<%=(rs01.Fields.Item("venID").Value)%>" target="_top"><img src="ico/ico_olho.gif" width="15" height="15" border="0"/></a></td>
