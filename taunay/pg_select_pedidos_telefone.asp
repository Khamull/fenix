...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
        ...
        <li><a href="pg_pedidos_fechados_telefone.asp">Pedidos Fechados</a></li>
	  </ul>
	</div>
    ...
    <table width="96%" border="0" align="left" cellpadding="3" cellspacing="3">
      <tr>
        ...
        <td width="751" align="center" class="titulo">PEDIDOS - TELEFONE</td>
      </tr>
      <tr>
        <td height="134" colspan="2" align="left" valign="top"><!-- REGISTRO -->
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
            ...
            <tr class="textoBranco">
              <td width="52" align="left" bgcolor="#9E231B">&nbsp;Codigo</td>
              <td width="70" align="left" bgcolor="#9E231B">Data</td>
              <td width="71" align="left" bgcolor="#9E231B">Hora Atend.</td>
              <td width="346" align="left" bgcolor="#9E231B">Cliente</td>
              <td width="69" align="left" bgcolor="#9E231B">&nbsp;Telefone</td>
              <td width="99" align="left" bgcolor="#9E231B">&nbsp;Atendente</td>
              <td width="15" bgcolor="#9E231B">Ed</td>
              <td width="19" bgcolor="#9E231B">St</td>
            </tr>
            <% 
...
%>
            ...
            <%if (rs01.Fields.Item("staID").Value = "1") Then%>
              ...
              <tr>
                ...
                <td><a href="pg_insert_itemVendaTelefone.asp?venID=<%=(rs01.Fields.Item("venID").Value)%>" target="_top"><img src="ico/ico_olho.gif" width="15" height="15" border="0"/></a></td>
