...
sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 6 OR tb_venda.staID = 10 AND tb_venda.tipVendaID = 1 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC"
	...
	case 1
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 10 OR tb_venda.staID = 6 AND tb_cliente.cliNome LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 1 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 2
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 10 OR tb_venda.staID = 6 AND tb_cliente.cliTelefone LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 1 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 3
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE tb_venda.staID = 10 OR tb_venda.staID = 6 AND tb_venda.venID = '"&keyword&"' AND tb_venda.tipVendaID = 1 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	end select 
...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
	    ...
	    <li><a href="pg_menu_pedidos.asp?tipo=telefone">Novo Pedido</a></li>
        <li><a href="pg_select_pedidos_telefone.asp">Pedidos Abertos</a></li>
	  </ul>
	</div>
    ...
    <table width="96%" border="0" align="left" cellpadding="3" cellspacing="3">
      <tr>
        ...
        <td width="751" align="center" class="titulo">PEDIDOS FECHADOS - TELEFONE</td>
      </tr>
      <tr>
        <td height="134" colspan="2" align="left" valign="top"><!-- REGISTRO -->
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
            <tr>
              <td colspan="8" align="left" valign="middle"><form method="get" name="form2" id="form2">
            ...
            <tr class="textoBranco">
              <td width="57" align="left" bgcolor="#9E231B">Codigo</td>
              <td width="69" align="left" bgcolor="#9E231B">Data</td>
              <td width="75" align="left" bgcolor="#9E231B">Hora Atend.</td>
              <td width="340" align="left" bgcolor="#9E231B">Cliente</td>
              <td width="70" align="left" bgcolor="#9E231B">&nbsp;Telefone</td>
              <td width="100" align="left" bgcolor="#9E231B">&nbsp;Atendente</td>
...
%>
            ...
            <%if (rs01.Fields.Item("staID").Value = "10" OR rs01.Fields.Item("staID").Value = "6") Then%>
              ...
              <tr>
                ...
                <td align="left"><%=(rs01.Fields.Item("cliNome").Value)%></td>
                <td align="left"><%=(rs01.Fields.Item("cliTelefone").Value)%></td>
                <td align="left"><%=(rs01.Fields.Item("usuLogin").Value)%></td>
                <td><a href="sis_devolve_telefone.asp?venID=<%=(rs01.Fields.Item("venID").Value)%>" target="_top"><img src="ico/ico_olho.gif" width="15" height="15" border="0"/></a></td>
