...
function fecharPedido()
{
	...
	{
	window.location.href = "pg_insert_itemVendaBalcao.asp?acao=fecharPedido&venID=<%=Request.QueryString("venID")%>";
	}
}
...
function excluirPedido()
{
	...
	{
		window.location.href = "pg_insert_itemVendaBalcao.asp?acao=excluirPedido&venID=<%=Request.QueryString("venID")%>";
	}
}	
</script>
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">CADASTRO ITENS - VENDA - BALCÃO</td>
    </tr>
  <tr>
    ...
    <form id="form1" name="form1" method="post" action="<%=Request.ServerVariables("SCRIPT_NAME")%>?venID=<%=Request.QueryString("venID")%>" onsubmit="return verForm(this)">
      <table width="777" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
          ...
          <td height="25" align="left"><input name="itePreco" type="text" id="itePreco" onChange="calcTotal()" onkeypress="calcTotal()" onkeydown="calcTotal()" value="<%=Replace(proPrecoVenda,",",".")%>" size="10" maxlength="10" readonly="readonly" /> 
          &nbsp;&nbsp;Total:
          <input name="iteSubTotal" type="text" id="iteSubTotal" value="<%=Replace(FormatNumber(proPrecoVenda),",",".")%>" size="10" maxlength="10" readonly="readonly" /></td>
        </tr>
        <tr>
