...
<div id="areaConteudo">
    ...
    <table width="96%" border="0" align="left" cellpadding="3" cellspacing="3">
      <tr>
        ...
        <td width="751" align="center" class="titulo">PEDIDOS</td>
      </tr>
      <tr>
        <td height="134" colspan="2" align="left" valign="top"><!-- REGISTRO -->
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
            ...
            <tr class="textoBranco">
              <td width="40" align="left" bgcolor="#9E231B">&nbsp;N°</td>
              <td width="70" align="left" bgcolor="#9E231B">Data</td>
              <td width="70" align="left" bgcolor="#9E231B">Hora Atend.</td>
              <td width="361" align="left" bgcolor="#9E231B">Cliente</td>
...
<%
	  ...
	  %>
              <tr>
                <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("venID").Value)%></td>
                <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("venData").Value)%></td>
                <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("venHoraA").Value)%></td>
                ...
                <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("usuLogin").Value)%></td>
                <td bgcolor="<%=cor%>"><a href="pg_insert_itemVendaTelefone.asp?venID=<%=(rs01.Fields.Item("venID").Value)%>" target="_top"><img src="ico/ico_olho.gif" width="15" height="15" border="0"/></a></td>
                <td bgcolor="<%=cor%>"><img src="ico/<%=(rs01.Fields.Item("staID").Value)%>.gif" width="15" height="15" border="0"/></td>
              </tr>
              <% 
