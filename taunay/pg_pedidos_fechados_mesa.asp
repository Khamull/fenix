...
'sql = "SELECT * FROM tb_venda WHERE staID = '10' ORDER BY venID DESC"

sql = "SELECT tb_mesa.mesID, tb_mesa.mesNumero, tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID INNER JOIN tb_mesa ON tb_mesa.mesID = tb_venda.mesID WHERE tb_venda.staID = 10 AND tb_venda.tipVendaID = 2 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	...
	case 1
	sql = "SELECT tb_mesa.mesID, tb_mesa.mesNumero, tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID INNER JOIN tb_mesa ON tb_mesa.mesID = tb_venda.mesID WHERE tb_venda.staID = 10 AND tb_cliente.cliNome LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 2 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 2
	sql = "SELECT tb_mesa.mesID, tb_mesa.mesNumero, tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID INNER JOIN tb_mesa ON tb_mesa.mesID = tb_venda.mesID WHERE tb_venda.staID = 10 AND tb_cliente.cliTelefone LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 2 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 3
	sql = "SELECT tb_mesa.mesID, tb_mesa.mesNumero, tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID INNER JOIN tb_mesa ON tb_mesa.mesID = tb_venda.mesID WHERE tb_venda.staID = 10 AND tb_venda.venID = '"&keyword&"' AND tb_venda.tipVendaID = 2 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	end select 
...
<div id="areaConteudo">
	...
	<div style="height:25px; line-height:25px; background:#ccc">Menu</div>    
	  <ul>
		...
		<li><a href="pg_select_pedidos_mesa.asp">Pedidos Abertos</a></li>         
	  </ul>
	</div>
    ...
    <table width="750" border="0" align="center" cellpadding="3" cellspacing="3">
      <tr>
        <td width="50" align="center"><img src="ico/ico_telefone.gif" width="60" height="60" class="icone" /></td>
        <td width="751" align="center" class="titulo">PEDIDOS FECHADOS - MESA</td>
      </tr>
      <tr>
        <td height="134" colspan="2" align="left" valign="top"><!-- REGISTRO -->
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
            <tr class="textoBranco">
              <td width="65" align="left" bgcolor="#9E231B">&nbsp;Codigo</td>
              <td width="108" align="left" bgcolor="#9E231B">Data</td>
              <td width="126" align="left" bgcolor="#9E231B">Hora Atend.</td>
              <td width="251" align="left" bgcolor="#9E231B">Número da Mesa</td>
              <td width="106" align="left" bgcolor="#9E231B">&nbsp;Atendente</td>
              <td width="16" bgcolor="#9E231B">Ed</td>
              <td width="22" bgcolor="#9E231B">St</td>
            </tr>
            <% 
...
%>
            ...
            <%if (rs01.Fields.Item("staID").Value = "10") Then%>
              ...
              <tr>
                ...
                <td align="left"><%=(rs01.Fields.Item("mesNumero").Value)%></td>
                <td align="left"><%=(rs01.Fields.Item("usuLogin").Value)%></td>
                <td><a href="sis_devolve_mesa.asp?venID=<%=(rs01.Fields.Item("venID").Value)%>" target="_top"><img src="ico/ico_olho.gif" width="15" height="15" border="0"/></a></td>
