...
window.location.href = "pg_insert_itemVendaMesa.asp?venID="+venID+"&itePreco="+itePreco+"&iteQtde="+iteQtde+"&tipDescr="+tipDescr+"&tipID="+tipID+"&cliID="+cliID+"&proDescricao="+proDescricao+"&proID="+proID;
...
function fecharPedido()
{
	...
	{
	window.location.href = "pg_insert_itemVendaMesa.asp?acao=fecharPedido&venID=<%=Request.QueryString("venID")%>";
	}
}
...
function excluirPedido()
{
	...
	{
		window.location.href = "pg_insert_itemVendaMesa.asp?acao=excluirPedido&venID=<%=Request.QueryString("venID")%>";
	}
}	
</script>
