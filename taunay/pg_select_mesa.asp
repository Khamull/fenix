...
sql = "SELECT * from tb_mesa ORDER BY mesNumero ASC" 
if (keyword = "") then
else
sql = "SELECT * from tb_mesa WHERE mesNumero LIKE '%"&keyword&"%' ORDER BY mesNumero ASC" 
end if
%>
...
<div id="areaConteudo">
  ...
  <tr>
    ...
    <td width="751" align="center" class="titulo">MESA</td>
    </tr>
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
      ...
      <tr class="textoBranco">
        ...
        <td colspan="3" align="left" bgcolor="#9E231B">Mesa</td>
...
<%
	  ...
	  %>
      <tr>
        <td align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("mesID").Value)%></td>
        <td colspan="3" align="left" bgcolor="<%=cor%>"><%=(rs01.Fields.Item("mesNumero").Value)%></td>
        <td bgcolor="<%=cor%>"><a href="pg_update_mesa.asp?mesID=<%=(rs01.Fields.Item("mesID").Value)%>"><img src="ico/ico_alterar.gif" width="15" height="15" border="0"/></a></td>
        <td bgcolor="<%=cor%>"><img src="ico/ico_<%=(rs01.Fields.Item("mesAtiva").Value)%>.gif" width="15" height="15" border="0"/></td>
