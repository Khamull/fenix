...
sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE (tb_venda.staID <> 4) AND tb_venda.tipVendaID = 4 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	...
	case 1
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE (tb_venda.staID = 1 OR tb_venda.staID = 4 OR tb_venda.staID = 5 OR tb_venda.staID = 6) AND tb_cliente.cliNome LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 4 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 2
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE (tb_venda.staID = 1 OR tb_venda.staID = 4 OR tb_venda.staID = 5 OR tb_venda.staID = 6) AND tb_cliente.cliTelefone LIKE '%"&keyword&"%' AND tb_venda.tipVendaID = 4 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	case 3
	sql = "SELECT tb_venda.venID, tb_venda.usuLogin, tb_venda.venData, tb_venda.venHoraA, tb_venda.tipVendaID, tb_venda.staID, tb_venda.cliID, tb_cliente.cliTelefone, tb_cliente.cliNome FROM tb_venda INNER JOIN tb_cliente ON tb_cliente.cliID = tb_venda.cliID WHERE (tb_venda.staID = 1 OR tb_venda.staID = 4 OR tb_venda.staID = 5 OR tb_venda.staID = 6) AND tb_venda.venID = '"&keyword&"' AND tb_venda.tipVendaID = 4 GROUP BY tb_venda.venID ORDER BY tb_venda.venID DESC" 
	end select 
...
<div id="areaConteudo">
    ...
    <table width="96%" border="0" align="left" cellpadding="3" cellspacing="3">
      <tr>
        <td width="50" align="center"><img src="ico/ico_site.gif" width="60" height="60" class="icone" /></td>
        <td width="751" align="center" class="titulo">PEDIDOS - INTERNET</td>
      </tr>
      <tr>
        <td height="134" colspan="2" align="left" valign="top"><!-- REGISTRO -->
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <label>
                <select name="filtro" id="filtro">
                  ...
                  <option value="2" selected="selected">Telefone do Cliente</option>
            ...
            <tr class="textoBranco">
              ...
              <td width="70" align="left" bgcolor="#9E231B">Hora</td>
              <td width="381" align="left" bgcolor="#9E231B">Cliente</td>
              <td width="60" align="left" bgcolor="#9E231B">&nbsp;Telefone</td>
              <td width="15" bgcolor="#9E231B">Imp</td>
...
<%
	  ...
	  %>
              <tr>
                ...
                <td bgcolor="<%=cor%>"><a href="pg_print_pedido.asp?venID=<%=(rs01.Fields.Item("venID").Value)%>" target="_blank"><img src="ico/ico_printer.gif" width="15" height="15" border="0"/></a></td>
